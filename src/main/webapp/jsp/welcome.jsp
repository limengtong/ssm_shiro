	    ...
	    <div class="" style="margin-top: 8px;">
	        ...
	        <div style="border: 1px #ddd solid;height: 232px;padding-top: 10px;">	        	                                    	
				<c:forEach var="announcements" items="${announcements }">
					<div>
						<a href="javascript:void(0);" onclick="showAnnouncement(${announcements.id })" style="margin-left: 10px;">${announcements.account.length()>25?announcements.account.substring(0,25):announcements.account }</a>
						<span class="f-r"  style="margin-right:10px;"><span>${announcements.createTime }</span></span>
					</div>
            	</c:forEach>						
	        </div>
	    </div>
